# https://github.com/dgp1130/llvm-bazel-foolang/blob/master/llvm.bzl
...
def _impl(ctx):
    ...
    name = "clang+llvm-%s-%s" % (version, ctx.attr.host_triple)
...
""" % (ctx.name, name, name, name, name, name, name, name))
